...
export class BibliothequeCtrl extends BaseCtrl {
  #service;

  constructor() {
    super(); // Appelle le constructeur de BaseCtrl
    ...
    if (submitBtn) {
      submitBtn.addEventListener("click", () => this.ajouterLivre());
    }
  }
  ...
  afficherResultat(data) {
    ...
    // Attacher les écouteurs d'événements pour les boutons de modification une fois pour tous
    ...
    // Attacher les écouteurs d'événements pour les boutons de suppression une fois pour tous
  ...
  async handleEditClick(id) {
    ...
    // Attacher les écouteurs avec {once: true} pour qu'ils se déclenchent une seule fois
